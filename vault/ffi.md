...
- [[almide-bindgen]] — Almide と他言語をつなぐためのバインディング生成ツール
- [[almide-wasm-bindgen]] — Almide を WebAssembly 経由で JavaScript から呼ぶための橋
- [[almide-lander]] — Almide の着地点となるネイティブ層
- [[almide]] — FFI を前提に設計された言語本体
- [[almide-js]] — JavaScript 側からの呼び出しを担う層
- [[lean4-rust-backend]] — Lean4 から Rust の世界に処理を渡す経路
- [[lean2ts]] — Lean の証明を TypeScript 側に持ち込むための変換

## 関連概念

- [[ir]] — 言語間で共通の中間表現を経由する設計
- [[effect-system]] — 言語をまたぐときに副作用をどう扱うかという視点
- [[sandbox]] — 外部言語のコードを安全に呼び出すための囲い
