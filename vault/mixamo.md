...
- [[blender|Blender]] — Mixamo のアニメーションを編集・調整するツール
- [[fbx|FBX]] — Mixamo の主要な入出力フォーマット
- [[vrm|VRM]] — VRoid → Blender → Mixamo → Unity のワークフローで使用
- [[unity|Unity]] — Mixamo アニメーションの最終描画先の一つ
