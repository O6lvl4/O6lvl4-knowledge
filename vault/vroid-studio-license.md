...
**[[creative-commons|CC0]]（シーシーゼロ）** とは「この作品の権利を完全に放棄します。誰のものでもありません」という宣言のこと。一度放棄したら二度と取り消せない。

フリー素材には「権利放棄（CC0）」と「使用許諾（権利は持ったまま使っていいよと許可する）」の2種類がある。VRoid のプリセットは後者。
