...
updated_at: 2026-08-21T12:18:40+09:00
---
...
この瞬間、2つの量を別々に観測している。「田中」を持っている度合いはずっと高いままだった。**今すぐ出せる度合いだけが低かった**。前者が貯蔵強度、後者が引き出し強度にあたる。
...
工学的に言い直すなら、**貯蔵強度は counter、引き出し強度は gauge** になる。前者は単調増加でリセットされず、後者は現在値で放っておくと下がる。同じ「強度」という名前がついているが、**片方は累積値、片方は現在値**で、比較する対象ですらない。
...
読み取る点は2つ。**gauge は何度も上下している**。そして**counter が下がった行は1つもなく、上がるのは「思い出した」行だけ**。

1年後に出てこないことは、失われたことを意味しない。日常語ではどちらも「忘れた」と言うので区別が消えるが、正確には次のように分かれる。

> **「思い出せない」は gauge が低い状態。「覚えていない」は counter が低い状態。**

そして実践上の急所がここにある。**勉強中に体感できるのは gauge だけ**で、伸ばしたいのは counter のほう。見えている数字と伸ばしたい数字が違うため、体感を頼りにすると構造的に外す(後述の「手応えと効果は逆相関する」はこの言い換えにあたる)。
...
**低評価は「効かない」ではない。** Dunlosky らの基準は、教材・学習者・測定課題を越えてどれだけ一般化するかと、正しく実行できるかにある。要約もキーワード記憶術も、条件が揃えば効く。ただし条件が狭く、実行の質で結果が割れるため、**まず勧める手法にはならない**という評価になっている。
...
最後の群が示唆的で、記憶術とイメージ化は**そもそも2軸を動かす技法ではない**。初回の符号化を助ける道具なので、想起の反復が担う仕事を代替しない。適用範囲が狭いのはこのためと読める。
