...
- [[gltf|glTF 2.0]] — VRM の基盤フォーマット
- [[vroid-studio|VRoid Studio]] — VRM を作る代表的ツール
- [[vroid-hub|VRoid Hub]] — VRM モデルの共有プラットフォーム
- [[vroid-studio-license|VRoid Studio ライセンス]] — VRoid Studio で作った VRM の権利と利用条件
- [[face-tracking|フェイストラッキング]] — VRM の表情定義（blendshapes）を駆動する技術
- [[3tene]] — VRM アバターを動かす VTuber アプリ
- [[nendo]] — Almide エコシステムでの VRM パース・レンダリングプロジェクト
- [[live2d|Live2D]] — 2D アバター技術（VRM は 3D 側の対比）
- [[vn3-license|VN3 ライセンス]] — VRM 向けに設計されたアバターライセンス体系
